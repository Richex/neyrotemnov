...
start_text = ['Неприятно познакомиться.',
              'Я вкусно покушал и решил подискутировать.',
              'Я за историческую правду.',
              'Новую игрушку нашёл, клоун?',
              'НУ ЧЁ КИЕВ ВЗЯЛИ ДА???',
              'Переживу Зеленского.',
              'Привет я твой злой БРАТ',
              'Привет. Не стоило сюда лезть.',
              'Сижу в кресле сейчас',
              'Тебя вроде и не звали сюда.',
              'Тебя кто вызывал сюда, клоун ёбаный?',
              'Тебя кто сюда звал, хуесос?',
              'Тебя кто-то вызывал?',
              'Тебя кто-то звал сюда?',
              'Ты меня к чему сюда позвал, мудозвон?']
...
common_text = ['))',
               ...
               'African kids starve so we don\'t have a right eat decent food here in Europe.',
               ...
               'Can\'t remember asking for your useless opinion.',
               'Can\'t see who asked.',
               'Chechnya is a Russian soil indeed.',
               'Crimea chose to be with Russia, didn\'t it?',
               'Don\'t remember asking.',
               'Estonia isn\'t real Europe.',
               'Fuck off nigga.',
               'Fuck off, you fucking moron.',
               'Fucking orc.',
               'Good thoughts.',
               'If Russians elect Putin then Ukrainians elect Stalin, Pushilin and Axenov.',
               'It\'s a shame these mighty Ukrainians allowed Holodomor to happen.',
               'It\'s a well known fact that Europe sponsored Huilo\'s regime.',
               'JAL',
               'Kill fucking slaves',
...
angry_text = ['Вы меня триггерить пытаетесь, но я вас раскусил.',
                 ...
                 'Где массовые митинги за Украину в Крыму?',
                 'Где маштабные антиоккупационные митинги в Крыму, Херсоне, Донбассе?',
                 'Как там протесты в Крыму, Донецке, Луганске и Херсоне? Жители на бутылке не сидят?',
                 'Мне Крым не впёрся лично.',
                 'Кончай форсить фейк про Крым.',
                 'Крым давно хотели вернуть, Майдан оказался очень кстати. Не полезли бы в Донбасс — щас бы уже все признали Кр*м...',
                 'Крым проебали вы, а виноват почему-то Навальный. Странно.',
                 'Крым – Украина?',
                 'Крым — не Украина?',
                 'Крым — это какая страна?',
                 'Крым отторгнут незаконно и вообще это всё плохо. При этом населению Крыма, в целом, было норм.',
                 'Нахуя себе на ровном месте уголовку создавать, клоун крымоёбский?',
                 'Посмотри результаты выборов до 2014 года в Крыму.',
                 'Крым 8 лет является де-факто частью России, где живут граждане России.',
                 'Почему Крым не протестует против оккупантов?',
                 'А сколько в украинском Крыму протестовало против войны?',
                 'Сколько там украинские терпели оккупацию Крыма, не напомнишь?',
                 'Спроси у Крымчан',
                 'Ты давай сначала Херсон верни (я не говорю вообще про Крым и Луганск), а потом и про репарации попиздим.']

ukrainian_lang_response = ['По-русски говори на этом сайте, будь ласка.',
                           'Переведи базу на русский язык.',
                           'Русская редакция, русский язык, русская аудитория, русский Комитет. Пиши на русском языке.',
                           'Языковой нацизм.',
                           'Почему на украинском пишешь, петух? Это русский сайт.',
                           'Когда перестанешь на русском сайте на мове своей писать?',
                           'Нормально писать по-русски научись, дурачок.',
                           'Тут говорят по-русски.',
                           'Зачем карась пытается ворваться на русский сайт на своей мове?',
                           'На украинские сайты пиздуй.',
                           'Это русский сайт. Почему на мове пишешь?',
                           'Почему на русском сайте не пишешь на русском языке?',
                           'Сайт российский.',
                           'Пиши на русском. Сайт создан русскими для русских в русском интернете на русском языке.',
                           'Ты зачем зашёл на русский сайт? Не вижу смысла в таких украинских тут.',
                           'Тэгните сюда местных мововчивцев.',
                           'Хватит строить из себя патриота украинского дивана. По-русски пизди.',
                           'Чому не росiйською?',
